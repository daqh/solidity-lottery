...
contract LotteryFactory {
    ...
    function createLottery(string memory _description, uint256 _expiration) public payable returns (Lottery) {
        Lottery lottery = new Lottery(msg.sender, _description, _expiration, msg.value);
