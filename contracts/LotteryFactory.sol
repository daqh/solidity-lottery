...
contract LotteryFactory {
    ...
    function createLottery(string memory _description, uint256 _expiration, uint256 _prize) public payable returns (Lottery) {
        Lottery lottery = new Lottery(msg.sender, _description, _expiration, _prize);
